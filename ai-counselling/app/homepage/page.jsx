...
import { FaBrain, FaChartLine, FaRocket, FaUserGraduate, FaLaptopCode, FaHandshake } from 'react-icons/fa';
          ...
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              <div className="flex-shrink-0 flex items-center">
                ...
                <span className="ml-2 text-xl font-bold text-gray-800">CareerAI</span>
              </div>
      ...
      <div className="relative overflow-hidden">
            ...
            <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
              <div className="sm:text-center lg:text-left">
                ...
                >
                  ...
                  <span className="block text-indigo-600">Ideal Career Path</span>
                </motion.h1>
                <motion.p 
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                ...
                >
                  Our AI-powered platform analyzes your skills, interests, and market trends to provide personalized career recommendations and upskilling resources tailored just for you.
                </motion.p>
        ...
        <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
          <img
            ...
            src="https://images.unsplash.com/photo-1573164574572-cb89e39749b4?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1350&q=80"
            alt="Career planning"
          />
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:text-center">
            ...
            <p className="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
              Leverage the power of machine learning to make informed career decisions.
            </p>
          </div>
            ...
            <dl className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
              <div className="relative">
                <dt>
                  ...
                  <p className="ml-16 text-lg leading-6 font-medium text-gray-900">Personalized Assessment</p>
                </dt>
                <dd className="mt-2 ml-16 text-base text-gray-500">
                  Comprehensive analysis of your skills, interests, and personality to identify career matches.
                </dd>
              </div>
              ...
              <div className="relative">
                <dt>
                  ...
                  <p className="ml-16 text-lg leading-6 font-medium text-gray-900">Market Trend Analysis</p>
                </dt>
                <dd className="mt-2 ml-16 text-base text-gray-500">
                  Real-time data on industry growth, salary expectations, and job demand.
                </dd>
              </div>
              ...
              <div className="relative">
                <dt>
                  ...
                  <p className="ml-16 text-lg leading-6 font-medium text-gray-900">Learning Resources</p>
                </dt>
                <dd className="mt-2 ml-16 text-base text-gray-500">
                  Curated courses, certifications, and learning paths to help you upskill.
                </dd>
              </div>
            </dl>
          </div>
          ...
          <div className="mt-10 grid gap-8 lg:grid-cols-3">
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600">
                "CareerAI helped me transition from marketing to software engineering by identifying my transferable skills and recommending the right courses. I'm now earning 40% more!"
              </p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md">
              <div className="flex items-center mb-4">
                <div className="h-12 w-12 rounded-full bg-indigo-100 flex items-center justify-center">
                  <span className="text-indigo-800 font-bold">AS</span>
                </div>
                <div className="ml-4">
                  <h4 className="text-lg font-bold">Amanda Smith</h4>
                  <p className="text-gray-600">Data Analyst</p>
                </div>
              </div>
              <p className="text-gray-600">
                "The skill gap analysis was eye-opening. I focused on learning exactly what I needed, and landed my dream job within 6 months."
              </p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md">
              <div className="flex items-center mb-4">
              ...
              <p className="text-gray-600">
                "I was stuck in my career until CareerAI showed me that my skills were perfect for UX design. The personalized learning path made the transition smooth."
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="bg-indigo-700">
        <div className="max-w-2xl mx-auto text-center py-16 px-4 sm:py-20 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-extrabold text-white sm:text-4xl">
            <span className="block">Ready to discover your ideal career path?</span>
          </h2>
      ...
      <footer className="bg-gray-800">
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center">
                <FaBrain className="h-8 w-8 text-indigo-400" />
            ...
            <div>
              ...
              <ul className="mt-4 space-y-4">
                ...
                <li><Link href="/guides" className="text-base text-gray-300 hover:text-white">Career Guides</Link></li>
                <li><Link href="/courses" className="text-base text-gray-300 hover:text-white">Courses</Link></li>
              </ul>
            </div>
            <div>
